...
class ModuleJob {
  ...
  instantiate() {
    ...
    return this.instantiated; // This is asyncId 47, the triggerAsyncId for asyncId 51 that we're searching for
  }
  ...
  async run() {
    ...
    // !!!!!!! This is asyncId 51, the asyncId that we're searching for
